...
//   return await AsyncStorage.getItem("shippingAddress");
// };
// const fetchPaymentMethod = async () => {
//   return await AsyncStorage.getItem("paymentMethod");
// };

// const initialState: AppState = {
//   userInfo: fetchUserInfo() ? JSON.parse(fetchUserInfo()!) : null,

//   cart: {
//     cartItems: fetchCartItems() ? JSON.parse(fetchCartItems()!) : [],
//     shippingAddress: fetchShippingAddress()
//       ? JSON.parse(fetchShippingAddress()!)
//       : {},
//     paymentMethod: fetchPaymentMethod() ? fetchPaymentMethod()! : "PayPal",
//     itemsPrice: 0,
//     shippingPrice: 0,
//     taxPrice: 0,
//     totalPrice: 0,
